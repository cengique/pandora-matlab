...
if ~exist(stats_db_name, 'file') || ~exist(Cm_db_name, 'file') || isfield(props, 'recalc')
...
% TODO: make this a method in tests_3D_db
num_pages = dbsize(for_stats_db, 3);
flat_stats_db = stats_db;
for page_num = 1:num_pages
  flat_stats_db = [ flat_stats_db; for_stats_db({'mean', 'SE', 'n'}, :, page_num)];
end
