...
a_vc = ...
    abf2voltage_clamp([ data_dir 'WTCdaCCL1/aCC_1/09914070.abf' ], ...
                      'WT Cd', struct('ichan', ':', 'numStdsThr', 10));


ts_no_curr = traceset_L1_passive([70, 78], ...
    struct('passive', [70,78]), ...
    'Avg No Currents', ...
    struct('fileTempl', '099140%d.abf', ...
           'baseDir', [path 'WTCdaCCL1/aCC_1/'], ...
           'leakSub', 1, 'docDir', 'matlab', ...
           'numStdsThr', 10));

[a_db, Cm_avg, plot_doc] = processCapEst(ts_no_curr); 