...
%         groupCol: Column name to pass as grouping variable to boxplotp.
%		
%   Returns:
...
if isfield(props, 'groupCol')
  a_plot = ...
      plot_abstract({get(delColumns(a_tests_db, props.groupCol), 'data'), ...
                     get(onlyRowsTests(a_tests_db, ':', props.groupCol), 'data'), ...
