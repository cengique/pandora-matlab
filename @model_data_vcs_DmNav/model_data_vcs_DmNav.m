...
%
% General methods of model_data_vcs_DmNav objects:
%   model_data_vcs_DmNav		- Construct a new model_data_vcs_DmNav object.
%
% Additional methods:
%   See methods('model_data_vcs_DmNav')
%
...
if nargin == 0 % Called with no params
  ...
  a_md.id = '';
  a_md = class(a_md, 'model_data_vcs_DmNav', trace);
elseif isa(model_f, 'model_data_vcs_DmNav') % copy constructor?
  a_md = model_f;
else
  if ~ exist('props', 'var')
    props = struct;
  ...
  a_md = class(a_md, 'model_data_vcs_DmNav');
end
