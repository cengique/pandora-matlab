...
% param_mult - Subclass that can hold multiple param_func objects.
%
...
%
% Internal functions:
% param_func_compiled - Imitates param_func, but has parameters embedded
% 			for speeding up integration. 
%
...
%
% Neuronal membrane, electrode, and amplifier simulation functions:
% param_vc_Rs_comp_int_t - Voltage clamp amplifier model of Rs
% 	compensation and passive or active membrane attached.
...
% 	capacitance.
% param_cc_Rs_comp_int_t - Current clamp amplifier model of Rs
% 	compensation and passive or active membrane attached.
