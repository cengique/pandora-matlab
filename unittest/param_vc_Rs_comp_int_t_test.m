  ...
  plotFigure(plot_stack({...
      plot_abstract({...
          [sim_pred80_vc.props.intOuts.I_prep(:, trace_num), ...
           sim_pred80_vc.props.intOuts.I_w(:, trace_num)]}, {'dt', 'nA'}, 'internals', ...
                    {'I_{prep}', 'I_{w}'}, 'plot'), ...
      plot_abstract({...
          [sim_pred80_vc.props.intOuts.Vp(:, trace_num), ...
           sim_pred80_vc.props.intOuts.Vm(:, trace_num), ...
           sim_pred80_vc.props.intOuts.Vm_Vw(:, trace_num)]}, {}, 'internals', ...
                    {'V_{p}', 'V_{m}', 'V_{w}'}, 'plot')}));  
  ...
  plotFigure(plot_stack({...
      ...
      plot_abstract({...
          [sim_corr80_vc.props.intOuts.Vp(:, trace_num), ...
           ...
           sim_corr80_vc.props.intOuts.Vm_Vw(:, trace_num), ...
